...
exports.getCategories = async (req, res) => {
  try {
    ...
    // Fetch categories linked to products for this branch (e.g., via Product model or direct Category query)
    const categories = await Category.find()
      .populate('products')
      .exec(); // Adjust query to filter by branch if needed
    // Filter categories based on branch products (assuming products have branchId or category linkage)
